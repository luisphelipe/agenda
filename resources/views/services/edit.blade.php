        ...
        <div class="card-body">
            ...
            <form action="{{ $service->link() }}" method="POST">
                ...
                <div class="input-group">
                    <input class="form-control" type="text" name="title" placeholder="Nome do servico" value="{{ $service->title }}">
                </div>
                ...
                <button type="submit" class="btn btn-primary">Editar Servico</button>
